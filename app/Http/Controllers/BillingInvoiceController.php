...
class BillingInvoiceController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select(DB::raw("b_i.*, o_r.*, cust.*, b_i.invoice_number as bi_inv_no, b_i.amount as bi_amount, o_r.customer_id as or_customer_id, b_i.date as date, b_i.id as id"))
        ->orderby('b_i.date','desc')
        ->paginate(15);
        // dd($billinginvoice);
    ...
    public function show($id)
    {
        ...
        $billinginvoice = BillingInvoice::select('bi.*','cus.*', DB::raw("TRIM(IF(cus.individual, CONCAT(cus.first_name, ' ', cus.middle_name, ' ', cus.last_name), cus.company_name)) as customer_name"))

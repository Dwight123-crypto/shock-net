...
<style>
    ...
    #tbl-items .fa-close:hover,
    #tbl-items .fa-close:focus {
        opacity: 1;
    }

    #tbl-items .fa-close.text-red:active {
        color: #b52e1e !important;
    }
    ...
    .table-account-details tr.optional {
        display: none;
    }
</style>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="pull-left">
            ...
            <h1>Create New Credit Invoice</h1>
    ...
    <section class="content">
        ...
        {!! Form::open(array('route' => 'credit-invoice.store','method'=>'POST')) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 right-info">
                        ...
                        <div class="input-group input-group-sm open-invoice">
                            ...
                            <div class="checkbox icheck">
                                ...
                                <label>
                                    ...
                                    <input type="checkbox" name="for_open_invoice" value="1"> for Open Invoice?
                        ...
                        <div class="input-group input-group-sm open-invoice-child">
                            ...
                            {!! Form::select('open_invoice_id', [], null, ['class' => 'form-control']) !!}
                    ...
                    <div class="col-md-6">
                        ...
                        <table class="table no-border sales-details">
                            ...
                            <tbody>
                                ...
                                <tr class="no_of_person-row show-on-discount">
                                ...
                                <tr class="no_of_scpwd-row show-on-discount">
                                ...
                                <tr class="discount-row">
                                    ...
                                    <td class="field-only">
                                        ...
                                        {!! Form::select('discounted', ['0' => 'No', '1' => 'Yes'], '', ['class' => 'form-control discounted']) !!}
                                ...
                                <tr class="vat_exempt_sales-row show-on-discount">
                                ...
                                <tr class="net_sales-row show-on-discount">
            ...
            <div class="box-body table-responsive no-padding">
                ...
                <table class="table table-hover table-account-details">
                    ...
                    <tbody>
                        ...
                        $main_debit = isset($account_rows[0]['Main_Debit']) ? $account_rows[0]['Main_Debit'] : null;

                        {!! view('_includes.account-row-template', [
                        'parent_name' => $parent_name,
                        'entry_type' => $entry_type,
                        'account_row_class' => $account_row_class,
                        'select' => $select,
                        'key' => $key
                        ]) !!}
                        ...
                        $withholding_tax_debit = isset($account_rows[1]['Withholding_Tax_Debit']) ? $account_rows[1]['Withholding_Tax_Debit'] : null;
                        ...
                        $discount_debit = isset($account_rows[2]['Discount_Debit']) ? $account_rows[2]['Discount_Debit'] : null;
                        ...
                        $main_credit = isset($account_rows[3]['Main_Credit']) ? $account_rows[3]['Main_Credit'] : null;
                        ...
                        $credit2 = isset($account_rows[4]['Credit2']) ? $account_rows[4]['Credit2'] : null;
                        ...
                        $vat_tax_credit = isset($account_rows[5]['Vat_Tax_Credit']) ? $account_rows[5]['Vat_Tax_Credit'] : null;
...
<script>
    ...
    var validation_url = '{{url("credit-invoice/add-form-validate")}}';
</script>

...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="pull-left">
            <h1>Create Non-OR Billing Invoice for Project ({{ $cm_project->id }} - {{ $cm_project->name }})</h1>
        </div>
    ...
    <section class="content">
      ...
      {!! Form::model($cm_project, ['method' => 'POST','route' => ['construction-monitoring-billing.store']]) !!}
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="col-sm-6">
                <div class="input-group input-group-sm" style="display: none;">
                    ...
                    <input type="hidden" name="customer_id" class="id" value="{{ $cm_project->customer_id }}">
                    
                    <span class="input-group-btn"><button type="button" class="btn btn-info btn-flat btn-search">Go!</button></span>
                </div>
                <button type="button" class="btn btn-info btn-flat customer-search_by_id hidden" data-customer_id="{{ $cm_project->customer_id }}">Hidden customer search by id</button>
            ...
            <div class="col-sm-6 right-info">
              <div class="input-group input-group-sm">
                <div class="input-group-btn"><button type="button" class="btn">Invoice No.</button></div>
                @if(empty($billing_invoice->billing_invoice_no))
                  <input type="text" name="invoice_no" class="form-control font-sizing" id="invoice_no" value="0" readonly>
                @else
                  <input type="text" name="invoice_no" class="form-control font-sizing" id="invoice_no" value="{{ $billing_invoice->billing_invoice_no }}" readonly>
                  {{-- <input type="hidden" name="invoice_no_copy" class="form-control" id="invoice_no_copy" value="{{ $billing_invoice->billing_invoice_no }}" readonly> --}}
                @endif
              </div>

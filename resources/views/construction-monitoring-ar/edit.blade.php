...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="pull-left">
            <h1>Edit account receivable for ID ({{ $cms_ar_edit->id }})</h1>
        </div>
    ...
    <section class="content">
      ...
      {!! Form::model($cms_ar_edit, ['method' => 'PATCH','route' => ['construction-monitoring-ar.update', $cms_ar_edit->id]]) !!}
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="col-sm-6">
                <div class="input-group input-group-sm" style="display: none;">
                    ...
                    <input type="hidden" name="customer_id" class="id" value="{{ $cms_ar_edit->customer_id }}">
                    
                    <span class="input-group-btn"><button type="button" class="btn btn-info btn-flat btn-search">Go!</button></span>
                </div>

                <button type="button" class="btn btn-info btn-flat customer-search_by_id hidden" data-customer_id="{{ $cms_ar_edit->customer_id }}">Hidden customer search by id</button>
            ...
            <div class="col-sm-6 right-info">
              ...
              <div class="input-group input-group-sm" style="margin-bottom: 10px;">
                ...
                {!! Form::text('amount', null, ['class' => 'form-control amount font-sizing', 'placeholder' => 'Enter the billing amount', 'readonly' , 'autocomplete' => 'off']) !!}
              </div>
            </div>
          </div>
        </div>

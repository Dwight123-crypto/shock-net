<script>
    ...
    function setup_invoice_dropdown( data ){
        ...
        /* credit_invoices id and invoice_number */
        for( var i in data ){
    ...
    function get_credit_invoices( customer_id ){
        
        var request = { customer_id: customer_id };
        $.get('{{url("customer/get-credit-invoices")}}', request, function(data){
    ...
    $('.btn-search, .customer-search_by_id').on('click', function(){
        ...
        $.get('{{url("cash-invoice/find-customer-only")}}', request, function(data){
            ...
            if(customer_id){
                get_credit_invoices( customer_id );
            }
        });
    });
    ...
    $('.table-invoice-details').on('change', 'select.invoice-dropdown', function(){
        ...
        $('[name=credit_invoice_id]').val( $(this).val() );
    });
    ...
    function show_form_errors( errors ){
        ...
        for(var i in errors){
            ...
            /* if the field is credit_invoice_id */
            if(error.field == 'credit_invoice_id'){

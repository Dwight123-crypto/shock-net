...
<div class="content-wrapper">
    ...
    {!! Form::open(['url' => '/collection-receipt']) !!}
            ...
            <div class="col-sm-6 right-info">
              <div class="input-group input-group-sm">
                <div class="input-group-btn">
                  <input type="hidden" name="credit_invoice_id" value="0" />
                  <button type="button" class="btn">CR No.</button>
                </div>
                <!-- /btn-group -->
                <input type="text" name="cr_number" class="form-control" readonly value="{{ $new_cr_number }}">
              </div>
              <div class="input-group input-group-sm">
                <div class="input-group-btn">
        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover table-invoice-details">
            ...
            <tr class="invoice-row">
              <td> <select class="form-control input-sm invoice-dropdown" name="cri[credit_invoice_id]"></select> {!! Form::hidden('invoice_number', null, ['class' => 'form-control']) !!} </td>
              <td> <input type="text" name="cri[description]" class="form-control input-sm description" readonly> </td>
              <td> <input type="text" name="cri[amount_payable]" class="form-control input-sm amount_payable" readonly> </td>
              <td> <input type="text" name="cri[current_payment]" class="form-control input-sm current_payment" readonly> </td>
            </tr>
...
<script>
    ...
    var validation_url = '{{url("collection-receipt/add-form-validate")}}';
</script>
@endsection
    ...
    <section class="content">
        <div class="table-responsive">
            ...
            <tr>
                ...
                <td class="right">{{ number_format($details_expenses, 2) }}</td>
            </tr>
            <tr>
                <td colspan="6" class="right"><strong>Overall Total</strong></td>
                <td class="right"><strong>{{ number_format($total_details_expenses, 2) }}</strong></td>
            </tr>
            </table>
            <div class="row" style="margin-right: 0px; margin-left: 0px;">
                <div class="col-md-2">
                    <a class="btn btn-primary" href="{{ url('construction-monitoring-expenses') }}"> Back</a>
                    <a class="btn btn-primary" href="{{ url('construction-monitoring-expenses/details', $cms_projects->id) }}"><i class="fa fa-refresh"></i> Refresh</a>
                </div>

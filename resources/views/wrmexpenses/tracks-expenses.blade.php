...
<div class="content-wrapper">
    <div class="row">
        ...
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h1>WRM Expenses Records</h1>
            </div>
        </div>
        <div style="clear: both; margin-bottom: 20px;"></div>
        <div class="col-lg-6 payroll-details">
            <h4>Track Expenses by Vendor's Name</h4>
            {!! Form::open(array('url' => 'wrmexpenses/tracks-expenses','method'=>'GET')) !!}
    ...
    <section class="content">
        <div class="table-responsive">
            ...
            <tr>
                ...
                <td align="center">
                    <a href="{{ url('wrmexpenses/' . $value->id . '/edit') }}" class="btn btn-primary btn-xs" title="Edit Expenses"><i class="fa fa-pencil"></i></a>
                    <a href="{{ url('wrmexpenses/' . $value->id) }}" class="btn btn-primary btn-xs" title="View Expenses"><i class="fa fa-eye"></i></a>
                    <a class="btn btn-danger btn-xs" href="{{ route('wrmexpenses/tracks-expenses.get.destroy', $value->id) }}" onclick = 'return confirm("Are you sure to delete this record?")'><i class="fa fa-trash"></i></a>
                </td>
            </tr>
            @endforeach
            </table>
        ...
        <div class="row" style="margin-right: 0px; margin-left: 0px;">
            <div class="pull-left" style="margin-bottom: 20px; margin-top: 20px;">
                ...
                <a href="{{ route('wrmexpenses.create') }}" class="btn btn-primary">Add Expenses</a>
            </div>

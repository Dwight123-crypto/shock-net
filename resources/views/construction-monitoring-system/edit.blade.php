...
<div class="content-wrapper">
    ...
    {!! Form::model($project, ['method' => 'PATCH','route' => ['construction-monitoring-system.update', $project->id]]) !!}
        ...
        <div class="box-body">
            ...
            <div class="col-sm-6 right-info">
                <div class="input-group input-group-sm" style="margin-bottom: 10px; width: 100%;">
                    ...
                    <input type="text" class="form-control datepicker" name="date" value="{{ $project->date }}" autocomplete="off">
                </div>
            </div>
                ...
                <div class="col-md-9 col-sm-12">
                    <table class="table no-border">
                        <tbody>
                            ...
                            <td class="field-only">
                                {!! Form::select('type', ['build'=>'Build', 'design'=>'Design'], null, ['class' => 'form-control']) !!}
                            </td>
                            </tr>
                            <tr class="name-row">
                            ...
                            <tr class="cost-row">
                                ...
                                <td class="field-only"><input type="text" name="cost" value="{{ number_format($project->cost, 2) }}" class="form-control project-cost"></td>
                            </tr>
                            <tr class="downpayment-row">
                                <td class="f-label">Downpayment</td>
                                <td class="field-only"><input type="text" name="downpayment" value="{{ number_format($project->downpayment, 2) }}" class="form-control project-downpayment"></td>
                            </tr>
                            <tr class="balance-row">
                                <td class="f-label">Balance</td>
                                <td class="field-only"><input type="text" value="{{ number_format($project->cost - $project->downpayment, 2) }}" class="form-control project-balance" readonly></td>
                            </tr>
                            <tr class="type-row">
                                <td class="f-label">Status</td>
                                <td class="field-only">
                                    {!! Form::select('status', ['Done'=>'Done', 'Ongoing'=>'Ongoing'], null, ['class' => 'form-control']) !!}
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>
                                    <div class="form-group">
                                        {!! Form::submit('Update', ['class' => 'btn btn-primary form-control save-project-entry']) !!}
                                    </div>
                                </td>
                            </tr>
                        </tbody>

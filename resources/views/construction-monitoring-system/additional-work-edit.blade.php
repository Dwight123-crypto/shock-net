...
.update-addition-work{width: 150px;}
.f-label{width: 150px;}
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="pull-left">
            <h1>Edit Additional Work</h1>
            <h4>Additional Work ID: ({{$additional_work->id}})</h4>
        </div>
        
        <div class="pull-right">
            <a class="btn btn-primary" href="{{ url('construction-monitoring-system/additional-work-list') }}"> Back</a>
        </div>
    ...
    {!! Form::model($additional_work, ['method' => 'GET','url' => ['construction-monitoring-system/additional-work-update', $additional_work->id]]) !!}
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="col-sm-6">
                ...
                <input type="hidden" name="customer_id" class="id" value="{{ $additional_work->customer_id }}">
       
                <button type="button" class="btn btn-info btn-flat customer-search_by_id hidden" data-customer_id="{{ $additional_work->customer_id }}">Hidden customer search by id</button>
                    ...
                    <table class="table no-border">
                        <tbody>
                            <tr class="cost-row">
                                ...
                                <td class="field-only">{!! Form::text('amount', null, ['class' => 'form-control aw-cost numbers-only', 'required']) !!}</td>
                            </tr>
                            <tr class="description-row">
                                <td class="f-label">Description</td>
                                <td class="field-only">{!! Form::text('description', null, ['class' => 'form-control']) !!}</td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>
                                    <div class="form-group">
                                        {!! Form::submit('Update', ['class' => 'btn btn-primary form-control update-addition-work']) !!}
                                    </div>
                                </td>
                            </tr>
                        </tbody>
...
<script type="text/javascript">
    ...
    $( document ).ready(function() {
        ...
        $(".aw-cost").val(accounting.formatMoney($('.aw-cost').val()));

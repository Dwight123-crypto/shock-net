...
<div class="content-wrapper">
	...
	<div class="table-responsive">
		...
		<div class="row">
			<div class="col-sm-3">
				<a href="{{ url('pos-expenses/tracks-expenses') }}" class="btn btn-primary">Back</a>
				<a href="{{ url('pos-expenses/' . $vendor_expenses->id . '/edit') }}" class="btn btn-primary" title="Edit Expenses"><i class="fa fa-pencil"></i> Edit Expenses</a>
			</div>
		</div>
	</section><!-- /.content -->
</div><!-- /.content-wrapper -->

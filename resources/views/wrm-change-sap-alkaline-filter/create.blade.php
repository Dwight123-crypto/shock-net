...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="pull-left">
            <h1>Change SAP filter Alkaline settings</h1>
        </div>
    ...
    {!! Form::open(array('route' => 'wrm-change-sap-alkaline-filter.store','method'=>'POST')) !!}
    
    <div class="box" style="padding: 10px;">
        <div class="input-group input-group-sm" style="margin-bottom: 10px;">
            <label>Enter no. of bottles to change SAP Alkaline filter</label>

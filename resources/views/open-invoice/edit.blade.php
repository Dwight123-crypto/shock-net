...
.table-invoice-details th.payment { width: 15%; }
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>
            Edit Open Invoice ({{ $openinvoice->id }})
        </h1>
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="col-sm-6">
              ...
              <button type="button" class="btn btn-info btn-flat customer-search_by_id hidden" data-customer_id="{{ $openinvoice->customer_id }}">Hidden vendor search by id</button>
            ...
            <div class="col-sm-6 right-info">
              <div class="input-group input-group-sm">
                <div class="input-group-btn">
                  ...
                  <button type="button" class="btn">OI No.</button>
                </div>
                <!-- /btn-group -->
                {!! Form::text('oi_number', null, ['class' => 'form-control', 'readonly' => 'readonly']) !!}
              </div>
              <div class="input-group input-group-sm">
                <div class="input-group-btn">
              ...
              <div class="input-group input-group-sm paymethod paymethod-cash">
                <div class="checkbox icheck">
                  <label>
                    {!! Form::checkbox('on_hand', '1', $openinvoice->on_hand==1) !!} On Hand
                  </label>
                </div>
                <div class="checkbox icheck">
                  <label>
                    {!! Form::checkbox('bank', '1', $openinvoice->bank==1) !!} Bank
                  </label>
                </div>
              </div>
        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover table-invoice-details">
            <tbody><tr class="head">
              ...
              <th class="invoice_amount">Invoice Amount</th>
            ...
            <tr class="invoice-row">
              ...
              <td> <input type="text" name="invoice_amount" value="{{ $invoice->invoice_amount }}" class="form-control input-sm amount_payable" readonly> </td>
              <td> <input type="text" name="amount" value="{{ $openinvoice->amount }}" class="form-control input-sm amount" readonly> </td>
            </tr>
            ...
            <!-- <tr class="total-row">
              <td colspan="3"> <input type="hidden" value="{{ $openinvoice->balance }}" name="balance"> Balance: </td>
              <td class="balance"> {{ number_format($openinvoice->balance, 2, '.', '') }} </td>
            </tr> -->
          </tbody></table>
        </div>
        <!-- ./box-body -->
    ...
    <div class="box account-details-section">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                <a href="{{url('open-invoice/account-details')}}" target="_blank" class="btn btn-box-tool" data-toggle="tooltip" title="" data-original-title="Manage Account Details"><i class="fa fa-wrench"></i></a>
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
            </div>
        </div>
            <div class="box-body table-responsive no-padding">
...
@include('open-invoice.form-script')  
<script>
    var validation_url = '{{url("open-invoice/edit-form-validate")}}';

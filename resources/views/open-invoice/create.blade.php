...
.input-group.payment_method, .input-group.sales_discount { margin-top: 20px; }
</style>
@endsection
        ...
        <div class="box-body">
            ...
            <div class="col-sm-6 right-info">
              <div class="input-group input-group-sm">
                ...
                <!-- /btn-group -->
                <input type="text" name="oi_number" class="form-control" readonly value="{{ $new_oi_number }}">
              </div>
              <div class="input-group input-group-sm">
                <div class="input-group-btn">
              ...
              <div class="input-group input-group-sm sales_discount">
                <div class="input-group-btn">
                  <button type="button" class="btn">Sales Discount</button>
                </div>
                <!-- /btn-group -->
...
<script>
    ...
    var validation_url = '{{url("open-invoice/add-form-validate")}}';
</script>
@endsection
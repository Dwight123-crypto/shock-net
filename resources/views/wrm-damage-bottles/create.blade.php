...
<div class="content-wrapper">
    ...
    {!! Form::open(array('route' => 'wrm-damage-bottles.store','method'=>'POST')) !!}
    
    <div class="box" style="padding: 10px;">
        <div class="row">
            <div class="col-sm-3">
                <div class="input-group input-group-sm" style="margin-bottom: 10px;">
                    <label>Numbers of damage bottles</label>
                    <input type="text" class="form-control" name="dmg_bottles" placeholder="No. of damage bottles">
                </div>
                <div class="input-group input-group-sm" style="margin-bottom: 10px;">
                    <label>Date</label>
    ...
    <div class="row">
      ...
      <div class="col-sm-9">
            <div class="form-group" style="text-align: right;">
                <a href="{{ url('wrm-damage-bottles/track-damage-bottles') }}" class="btn btn-primary">Track Damage Bottles</a>
            </div>
      </div>
    </div>

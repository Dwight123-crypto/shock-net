...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="pull-left">
            <h1>Create New Billing Invoice</h1>
        </div>
    ...
    {!! Form::open(['url' => '/billing-invoice', 'class' => 'create']) !!}
    ...
    <div class="box service">
        ...
        <div class="box-body">
            <div class="input-group searh-service-box">
              ...
              <span class="input-group-btn"><button type="button" class="btn btn-primary btn-flat btn-get_service">Enter</button></span>
            </div>
            <br>
                ...
                <table id="tbl-items" class="table table-bordered table-striped table-hover table-service-info">
                  <thead>
                    <tr>
                        ...
                        <th class="subtotal text-center" style="width: 133px">Rate</th>
                    </tr>
                  </thead>
                  <tbody>
                  </tbody>
                  <tfoot>
                    <tr class="total-row">
                      <td colspan="2" class="text-right"> <input type="hidden" name="amount" class="form-control amount" value="0.00" readonly=""> Total: </td>
...
<script>
    ...
    var validation_url = '{{url("billing-invoice/add-form-validate")}}';
</script>
<style>
  td.barcode{
    font-weight: 600;

...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="table-responsive">
          {!! Form::open(array('url' => 'list-employees/payroll','method'=>'POST', 'class' => 'addtopayroll')) !!}
            ...
            <tr>
                <td>{{ Form::checkbox('select[]', $employee->id, null, ['class' => 'select-emp']) }}</td>
                <td>{{ ++$i }}</td>
            ...
            <div class="pull-left">
                <button type="submit" class="btn btn-primary addtopay">Add to Payroll</button>
            </div>

...
<div class="content-wrapper">
    ...
    {!! Form::open(['url' => '/cash-payment-voucher']) !!}
            ...
            <div class="col-sm-6 right-info">
              <div class="input-group input-group-sm">
                <div class="input-group-btn">
                  <input type="hidden" name="supplier_invoice_id" value="0" />
                  <button type="button" class="btn">CV No.</button>
                </div>
                <!-- /btn-group -->
                <input type="text" name="cv_number" class="form-control" readonly value="{{ $new_cv_number }}">
              </div>
              <div class="input-group input-group-sm">
                <div class="input-group-btn">
        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover table-invoice-details">
            ...
            <tr class="invoice-row">
              <td> <select class="form-control input-sm invoice-dropdown" name="sii[0][supplier_invoice_id]"></select> {!! Form::hidden('invoice_number', null, ['class' => 'form-control']) !!} </td>
              <td> <input type="text" name="sii[0][description]" class="form-control input-sm description" readonly> </td>
              <td> <input type="text" name="sii[0][amount_payable]" class="form-control input-sm amount_payable" readonly> </td>
              <td> <input type="text" name="sii[0][current_payment]" class="form-control input-sm current_payment" readonly> </td>
            </tr>
            <tr class="total-row">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover table-account-details">
                ...
                <tr class="account-row credit">
                  <td class="account-number"> <input type="text" name="vouchers[1][code]" value="" class="form-control input-sm credit code" readonly /> </td>
                  <td class="account-title"> 
                  ...
                  <td class="credit"> <input type="text" name="vouchers[1][credit]" value="" class="form-control input-sm credit credit-field" readonly /> </td>
...
<script>
    ...
    var validation_url = '{{url("cash-payment-voucher/add-form-validate")}}';
</script>
@endsection
        ...
        <div class="box-header with-border">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover table-account-details">
                ...
                {!! view('_includes.account-row-template', compact('parent_name', 'entry_type', 'account_row_class', 'select', 'key')) !!}
                ...
                {{-- */extract($account_rows[6]);/* Credit3 optional --}}
                {!! view('_includes.account-row-template', compact('parent_name', 'entry_type', 'account_row_class', 'select', 'key')) !!}

                {{-- */extract($account_rows[7]);/* Credit4 optional --}}
                {!! view('_includes.account-row-template', compact('parent_name', 'entry_type', 'account_row_class', 'select', 'key')) !!}
                <tr class="total-row">
                  <td>  </td>
...
<script>
    ...
    var validation_url = '{{url("cash-invoice/add-form-validate")}}';
</script>
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <table class="table no-border sales-details">
                            <tbody>
                                <tr class="exempt-row">
                                    <td class="text-right f-label">Exempt</td>
                                    <td colspan="2" class="field-only">{!! Form::text('exempt', null, ['class' => 'form-control exempt numbers-only']) !!}</td>
                                </tr>
                                <tr class="zero_rated-row">
                                    <td class="text-right f-label">Zero-Rated</td>
                                    <td colspan="2" class="field-only">{!! Form::text('zero_rated', null, ['class' => 'form-control zero_rated numbers-only']) !!}</td>
                                </tr>
                                <tr class="total_sales-row">
                                    <td class="text-right f-label">Total Sales</td>
                                    <td colspan="2" class="field-only">{!! Form::text('total_sales', null, ['class' => 'form-control total_sales numbers-only', 'readonly']) !!}</td>
                                </tr>
            ...
            <div class="box-body table-responsive no-padding">
                <table class="table table-hover table-account-details">
                    <tbody>
                        ...
                        $main_debit = $account_rows[0]['main_debit'];

                        @include('_includes.account-row-template', [
                        ...
                        $withholding_tax_debit = $account_rows[1]['withholding_tax_debit'] ?? null;
                        ...
                        $discount_debit = $account_rows[2]['discount_debit'] ?? null;
                        ...
                        $main_credit = $account_rows[3]['main_credit'];
                        ...
                        $credit2 = $account_rows[4]['credit2'] ?? null;
                        ...
                        $vat_tax_credit = $account_rows[5]['vat_tax_credit'];
                        ...
                        $credit3 = isset($account_rows[6]['Credit3']) ? $account_rows[6]['Credit3'] : null;
                        ...
                        $credit4 = isset($account_rows[7]['Credit4']) ? $account_rows[7]['Credit4'] : null;

...
<div class="content-wrapper">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped table-hover">
            <tbody>
                <tr>
                    <th>Account No.</th><td>{{ $customer->barcode }}</td>
                </tr>
                ...
                <tr>
                    <th> Barcode </th>
                    <td> @if(empty($customer->barcode)) @else
                        <input type="hidden" value="{{ $customer->barcode }}" id="bc-val"/>
                        <img id="barcode">
                        <a id="barcode-download" class="btn btn-primary" download="{{$customer->barcode}}" href="" style="position: absolute; margin-left: 15px; margin-top: 5px;">Download Barcode</a>
                        @endif
                    </td>
                </tr>
            </tbody>

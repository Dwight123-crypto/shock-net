...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="row search-bar-customer">
                {!! Form::open(array('url' => 'customer/search-customer','method'=>'GET')) !!}
                    <div class="col-md-10 col-sm-10" style="padding-right: 0px;">
                        <input type="text" name="search" class="search-customer form-control" placeholder="Search Customers Name or Account No."/>
                    </div>

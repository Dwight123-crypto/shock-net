...
<div class="content-wrapper">
    ...
    {!! Form::open(array('route' => 'wrm-regenerate-settings.store','method'=>'POST')) !!}
    
    <div class="box" style="padding: 10px;">
        <div class="input-group input-group-sm" style="margin-bottom: 10px;">
            <label>Enter no. of bottles to regenerates base on machines</label>
            <input type="text" class="form-control" name="reg_bots_value" placeholder="No. of bottles to regenerates">
        </div>
    </div>
    <div class="row">
      <div class="col-sm-1">

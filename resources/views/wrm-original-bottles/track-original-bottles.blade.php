...
<div class="content-wrapper">
    <div class="row">
        ...
        <div class="col-lg-6 payroll-details">
            <h4>Track Original Bottles by Date Range</h4>
        ...
        <div class="table-responsive">
            ...
            <tr>
                ...
                <td align="center">
                    ...
                    <a class="btn btn-danger btn-xs" href="{{ route('wrm-original-bottles/track-original-bottles.get.destroy', $value->id) }}" onclick = 'return confirm("Are you sure to delete this record?")'><i class="fa fa-trash"></i></a>
                </td>
            </tr>
            @endforeach
            </table>
